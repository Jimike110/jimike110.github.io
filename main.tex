...
% SUMMARY
% =============================================================================
\section*{Основной стек}
React.js, Next.js, TypeScript, JavaScript (ES6+), Redux Toolkit, Tailwind CSS, HTML, CSS (SASS/SCSS), REST API, Node.js, PostgreSQL, Supabase, Docker, CI/CD, Git, Figma, Webpack, Vite.
...
\entry{Frontend Developer}{Avito}{Январь 2026 - Настоящее время}
\begin{itemize}
    \item Разработка и масштабирование: Проектирование и реализация сложных интерфейсов для внутренних бизнес-инструментов и высоконагруженных продуктов компании.
    
    \item Архитектурные решения: Участие в развитии фронтенд-архитектуры на базе React, Redux и TypeScript, внедрение модульных решений и оптимизация производительности (Core Web Vitals).

    \item Quality Assurance: Покрытие кода "армией тестов" (Jest, React Testing Library), мониторинг стабильности приложения и оперативное исправление багов с использованием Sentry.

    \item Stakeholder Management: Активное взаимодействие с кросс-функциональными командами (маркетологи, аналитики, бэкенд-разработчики) для уточнения требований и декомпозиции задач.

    \item Data-driven development: Работа с внутренними системами аналитики для принятия продуктовых решений и оценки эффективности внедренных фич.

    \item AI-Driven Workflow: Интеграция передовых AI-инструментов (LLMs, Агенты) в процесс разработки, что позволило кратно увеличить скорость написания кода без потери качества (10x productivity approach).
\end{itemize}
\vspace{1ex}

\entry{Frontend Developer}{Jimike Codes}{Март 2024 – Января 2026}
